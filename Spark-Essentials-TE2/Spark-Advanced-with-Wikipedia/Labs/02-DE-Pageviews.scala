// Databricks notebook source exported at Wed, 1 Jun 2016 22:59:48 UTC
...
// MAGIC %md ####![Databricks Logo Tiny](http://curriculum-release.s3-website-us-west-2.amazonaws.com/wiki-book/general/logo_databricks_tiny.png) **Upload Pageviews file from your PC to a Databricks Table**
// MAGIC 
...
// MAGIC %md ####![Databricks Logo Tiny](http://curriculum-release.s3-website-us-west-2.amazonaws.com/wiki-book/general/logo_databricks_tiny.png) **Download Pageviews file from Amazon S3 into a Databricks Table**
