# Databricks notebook source exported at Tue, 22 Sep 2015 16:03:33 UTC
# MAGIC %md
# MAGIC 
...
# MAGIC #### This lab will introduce you to using Apache Spark 1.4 with the Python API. We will explore common transformations and actions including
