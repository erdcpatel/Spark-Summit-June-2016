# Databricks notebook source exported at Tue, 17 May 2016 21:41:56 UTC
...
# MAGIC       n AS count FROM clicks
# MAGIC     WHERE 
# MAGIC       curr_title IN ('Apache_Spark', 'Apache_Hadoop', 'Apache_Cassandra', 'Apache_Tomcat', 'Apache_HTTP_Server') AND
# MAGIC       prev_id IS NOT NULL AND NOT (curr_title = 'Main_Page' OR prev_title = 'Main_Page')
# MAGIC     ORDER BY n DESC
# MAGIC     LIMIT 20""").as[Edge])
